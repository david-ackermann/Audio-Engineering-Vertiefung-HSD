...
Dieser Block schließt Vorlesung 5 ab. Die Studierenden haben bis hierhin gesehen:
...
Jetzt kommt die zweite Sicht auf dieselbe Systemwirkung:
...
| 42-45 min | Abschluss und Ausblick | $H(e^{j\Omega})$ unabhängig von $N$ | Übergang zu Delay/Speicher |
...
- Vorlesung 6 baut daraus konkrete DSP-Strukturen: Delay, Speicher und Differenzengleichung.
